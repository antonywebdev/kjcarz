...
<tr class="wprevpro_row">
				...
				?>
					...
					<p class="description">
					<?php _e('More styles and options available in <a href="?page=wp_google-get_pro">Pro Version</a> of plugin!', 'wp-google-reviews'); ?></p>
				</td>
			</tr>
			<tr class="wpfbr_row">
				<th scope="row">
			...
			<tr class="wpfbr_row">
				...
				<td>
					...
					<?php _e('Upgrade to the <a href="https://ljapps.com/wp-review-slider-pro/">Pro Version</a> to access a lot more slider settings!', 'wp-google-reviews'); ?>
					</p>
