...
function automobile_car_dealer_customize_register( $wp_customize ) {	
	...
	$wp_customize->add_control('automobile_car_dealer_layout_options',array(
        'type' => 'radio',
        'label' => __('Post Sidebar Layout','automobile-car-dealer'),
        'section' => 'automobile_car_dealer_option',
        'choices' => array(
...
//sidebar size option
$wp_customize->add_setting('automobile_car_dealer_sidebar_size',array(
		'default' => 'Sidebar 1/3',
		'sanitize_callback' => 'automobile_car_dealer_sanitize_choices'
	));
	$wp_customize->add_control('automobile_car_dealer_sidebar_size',array(
		'type' => 'radio',
		'label' => __('Sidebar Size Option','automobile-car-dealer'),
		'section' => 'automobile_car_dealer_option',
		'choices' => array(
		   'Sidebar 1/3' => __('Sidebar 1/3','automobile-car-dealer'),
		   'Sidebar 1/4' => __('Sidebar 1/4','automobile-car-dealer'),
		),
	) );

	$wp_customize->add_setting( 'automobile_car_dealer_image_border_radius', array(
		'default'=> 0,
		'transport' => 'refresh',
		'sanitize_callback'	=> 'sanitize_text_field'
	) );
	$wp_customize->add_control(new Automobile_Car_Dealer_Custom_Control( $wp_customize,  'automobile_car_dealer_image_border_radius', array(
		'label'       => esc_html__( 'Featured Image Border Radius','automobile-car-dealer' ),
		'section'     => 'automobile_car_dealer_option',
		'type'        => 'number',
		'input_attrs' => array(
			'step'             => 1,
	...
	$wp_customize->add_setting( 'automobile_car_dealer_image_box_shadow',array(
		'default' => 0,
		'type'                 => 'theme_mod',
		'transport' 		   => 'refresh',
	...
	$wp_customize->add_control(new automobile_car_dealer_Custom_Control( $wp_customize,  'automobile_car_dealer_image_box_shadow',array(
		'label' => esc_html__( 'Featured Image Shadow','automobile-car-dealer' ),
		'section' => 'automobile_car_dealer_option',
		'input_attrs' => array(
			'min' => 0,
			'max' => 50,
   ...
   $wp_customize->add_control( 'automobile_car_dealer_pagination_settings', array(
	...
	$wp_customize->add_setting('automobile_car_dealer_slider_heading',array(
		'default' => true,
		'sanitize_callback'	=> 'automobile_car_dealer_sanitize_checkbox'
	));
	$wp_customize->add_control('automobile_car_dealer_slider_heading',array(
		'type' => 'checkbox',
		'label' => __('Enable / Disable Slider Heading','automobile-car-dealer'),
		'section' => 'automobile_car_dealer_slidersettings'
	));

	$wp_customize->add_setting('automobile_car_dealer_slider_text',array(
       'default' => true,
       'sanitize_callback'	=> 'automobile_car_dealer_sanitize_checkbox'
    ));
    $wp_customize->add_control('automobile_car_dealer_slider_text',array(
       'type' => 'checkbox',
       'label' => __('Enable / Disable Slider Text','automobile-car-dealer'),
       'section' => 'automobile_car_dealer_slidersettings'
    ));
	...
	$wp_customize->add_setting('automobile_car_dealer_slider_content_top_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new automobile_car_dealer_Custom_Control( $wp_customize,  'automobile_car_dealer_slider_content_top_padding',array(
		'label'	=> __('Top Bottom Slider Content Spacing','automobile-car-dealer'),
		'section'=> 'automobile_car_dealer_slidersettings',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('automobile_car_dealer_slider_content_left_padding',array(
		'default'=> '',
		'sanitize_callback'	=> 'sanitize_text_field'
	));
	$wp_customize->add_control(new automobile_car_dealer_Custom_Control( $wp_customize,  'automobile_car_dealer_slider_content_left_padding',array(
		'label'	=> __('Left Right Slider Content Spacing','automobile-car-dealer'),
		'section'=> 'automobile_car_dealer_slidersettings',
		'input_attrs' => array(
            'step'             => 1,
			'min'              => 0,
	...
	$wp_customize->add_setting('automobile_car_dealer_footer_text_align',array(
        'default' => 'center',
        'sanitize_callback' => 'automobile_car_dealer_sanitize_choices'
	));
	$wp_customize->add_control('automobile_car_dealer_footer_text_align',array(
        'type' => 'radio',
        'label' => __('Copyright Text Alignment ','automobile-car-dealer'),
        'section' => 'automobile_car_dealer_footer_section',
        'choices' => array(
            'left' => __('Left Align','automobile-car-dealer'),
            'right' => __('Right Align','automobile-car-dealer'),
            'center' => __('Center Align','automobile-car-dealer'),
        ),
	) );
